...
folderNames = {'D:\yueqi\axoft-data\cortexlab-dataset\dualPhase\posterior', ...
    'D:\yueqi\axoft-data\cortexlab-dataset\dualPhase\frontal'}; 
nShanks = length(folderNames);
Fs = 30000;
...
load(fullfile('D:\yueqi\axoft-data\cortexlab-dataset\dualPhase\posterior', 'forPRBimecP3opt3.mat'))
...
load('D:\yueqi\axoft-data\cortexlab-dataset\dualPhase\timeCorrection.mat')
...
load('D:\yueqi\axoft-data\cortexlab-dataset\dualPhase\experiment2stimInfo.mat')
